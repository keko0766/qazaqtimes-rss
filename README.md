...
Default және ұсынылатын модель — `qwen2.5:7b`.

Модель таңдауы:

- `qwen2.5:3b` — жеңіл режим; қазақша мәтіні әлсіз, fallback жиі болады
- `qwen2.5:7b` — ұсынылатын баланс, қазақша мақала сапасы жақсырақ
- `qwen2.5:14b` — ауыр quality mode; жабдық рұқсат етсе қолданыңыз

Модельді `7b` қылып бекіту үшін `.env` ішінде, әсіресе `.env` бұрын жасалған болса:

```env
OLLAMA_MODEL=qwen2.5:7b
```

Сосын қайта іске қосыңыз:
